...
const AvailavlePlayers = ({ fetchPlayers, setAvailavleValance, availavleValance , purchasedPlayers , setPurchasedPlayers }) => {
...

{
    playersData.map(player => <PlayerCard 
        ...
        setAvailavleValance= {setAvailavleValance} player={player}
        purchasedPlayers={purchasedPlayers}
        setPurchasedPlayers={setPurchasedPlayers}
        
        
        ></PlayerCard>//here playerCard a seperate component is created for each card...here setAvailavleValance,availavleValance are passed as props to the playerCard component and imported from app.jsx useState
        // console.log(player);
